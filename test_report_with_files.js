...
async function testReportWithFiles() {
  try {
    console.log('بدء اختبار رفع تقرير مع ملفات PDF وصورة...');
    ...
    // رابعاً: إضافة تقرير مع الملفات
    console.log('4. إضافة تقرير مع الملفات...');
    
    // إنشاء FormData
    const FormData = require('form-data');
    const form = new FormData();
    
    form.append('title', 'تقرير تجريبي مع ملفات');
    form.append('summary', 'ملخص تجريبي للتقرير مع ملفات');
    form.append('content', '<p>محتوى تجريبي للتقرير مع ملفات PDF وصورة</p>');
    ...
    if (reportResponse.ok) {
      console.log('✅ تم إنشاء التقرير مع الملفات بنجاح!');
      console.log('الرد:', reportResult);
    } else {
      console.log('❌ فشل في إنشاء التقرير مع الملفات');
